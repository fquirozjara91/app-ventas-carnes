...
const navItems: { label: string; href: string; disabled?: boolean; icon: React.ReactNode }[] = [
  {
    label: 'Inicio',
    href: '/',
    icon: (
    ...
    <aside className="w-16 md:w-56 bg-slate-900 flex flex-col min-h-screen shrink-0">
      ...
      <div className="px-4 py-5 border-b border-slate-800">
        <div className="flex items-center gap-3">
          ...
          <span className="hidden md:block text-white font-black text-sm uppercase tracking-widest">
            Ventas
          </span>
        </div>
      </div>
